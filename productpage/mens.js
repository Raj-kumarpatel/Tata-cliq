...
//     let id = ele.id
//     console.log("ID",id)
//     let url = 'http://localhost:3000/men-dresses/'+id
...
{
    let url = 'http://localhost:3000/men-dresses'
...
//     if (sortVal==="low") 
//     {
//         let url = 'http://localhost:3000/men-dresses?_sort=price&_order=asc'
//         try {
//             let response = await getData(url);
//             myProducts = response;
//             displayProducts(myProducts)
...
//     {
//         let url = 'http://localhost:3000/men-dresses?_sort=price&_order=desc'
//         try {
//             let response = await getData(url);
//             myProducts = response;
//             displayProducts(myProducts)
...
document.getElementById("brand").addEventListener("change",async function(){
    ...
    let url1 = 'http://localhost:3000/men-dresses'
    let url2 = 'http://localhost:3000/men-dresses?name='+filterVal
    if(filterVal==="Select") {
