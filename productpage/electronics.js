...
//     if (sortVal==="low") 
//     {
//         let url = 'http://localhost:3000/electronics?_sort=price&_order=asc'
//         try {
...
//     {
//         let url = 'http://localhost:3000/electronics?_sort=price&_order=desc'
//         try {
//             let response = await getData(url);
//             myProducts = response;
//             displayProducts(myProducts)
...
document.getElementById("brand").addEventListener("change",async function(){
    ...
    let url1 = 'http://localhost:3000/electronics'
    let url2 = 'http://localhost:3000/electronics?name='+filterVal
    if(filterVal==="Select") {
